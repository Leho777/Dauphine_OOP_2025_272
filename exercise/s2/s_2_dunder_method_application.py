...
1. **Implement the `__str__` Method**: The `__str__` method should return a string representation of the
    ...
    the desired string representation behavior.
...
Implement the __add__ Method:
    ...
    If the object being added is not of the FinancialAsset type, raise a TypeError.
...
Implement the __sub__ Method:
    ...
    If the object being subtracted is not of the FinancialAsset type, raise a TypeError.
